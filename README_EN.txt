...
full text in [`LICENSE`](LICENSE) (plain text, shown by GitHub in the repo's **License** tab) and
summarized below. A verifiable certificate with License ID
`282-20260913-d0fb6ee2-c5b7-4763-aa7e-e5e5f931edf2` is available as
[`LICENSE-certificate.pdf`](LICENSE-certificate.pdf) (opens directly on GitHub) or the original
styled [`LICENSE-certificate.html`](LICENSE-certificate.html). Generated by the SESL
