...
full text in [`LICENSE.html`](LICENSE.html) (a certificate with a verifiable License ID,
`282-20260913-d0fb6ee2-c5b7-4763-aa7e-e5e5f931edf2`; GitHub always shows `.html` files as raw
source when viewed in the repo — **[open it rendered via
htmlpreview](https://htmlpreview.github.io/?https://github.com/rusproektstroi-star/Cadence/blob/main/LICENSE.html)**,
or download the file and open it locally in a browser) and summarized below. Generated by the SESL
configurator — statistics and the configuration generator itself:
